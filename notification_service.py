...
def send_schedule_email(schedule_data: Dict[str, Any], assigned_employees: Dict[str, List[str]]) -> bool:
    """
    Send schedule email to assigned employees.
    
    Args:
        schedule_data: Schedule data dictionary
        assigned_employees: Dictionary mapping roles to employee lists
...
def send_combined_forecast_email(tomorrow_data: Dict[str, Any], day_after_data: Dict[str, Any], 
    ...
    try:
        # Create email message
        msg = MIMEMultipart("alternative")
        msg["Subject"] = f"Forecast and Staffing Alert for {tomorrow_data.get('date')} and {day_after_data.get('date')} for Bay 2 RO"
        msg["From"] = EMAIL_CONFIG["sender_email"]
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1>Forecast and Staffing Alert for Bay 2 RO</h1>
                </div>
                ...
                <div class="content">
                    ...
                    <div class="day-section">
                        ...
                        <div class="staff-section">
                            ...
                            <p style="margin-left: 20px;">- Staff: {tomorrow_staff.get('replenishment_staff', 0)}</p>
                    ...
                    <div class="day-section">
                        ...
                        <div class="staff-section">
                            ...
                            <p><strong>Replenishment:</strong></p>
                            <p style="margin-left: 20px;">- Staff: {day_after_staff.get('replenishment_staff', 0)}</p>
